class CreateShipuryTables < ActiveRecord::Migration
  def self.up
  ...
  def self.down
    drop_table :shipury_zones
    drop_table :shipury_services
    drop_table :shipury_rates
    drop_table :shipury_carriers
  end
end
